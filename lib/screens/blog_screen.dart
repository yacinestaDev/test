                    ...
                    ? Column(
                        ...
                        children: [
                          Column(
                            children: [
                              8.height,
                              mHeading(languages.lblTopFitnessReads,
                                  onCall: () {
                                ViewAllBlogScreen(isFeatured: true)
                                    .launch(context);
                              }),
                              SizedBox(
                                width: context.width(),
                                ...
                                child: Swiper(
                                  ...
                                  itemBuilder:
                                    ...
                                    return FeaturedBlogComponent(
                                        mBlogModel: mFeaturedBlogList[index]);
                                  },
                          ...
                          Column(
                            children: [
                              ...
                              mHeading(languages.lblTrendingBlogs, onCall: () {
                                ViewAllBlogScreen(isFeatured: false)
                                    .launch(context);
                              }),
                              ListView.builder(
                                shrinkWrap: true,
                    ...
                    : Stack(
                        children: [
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return BlogComponent(
                                  mBlogModel: mSearchBlogList[index]);
                            },
                          ).paddingTop(16),
                          SizedBox(
                            ...
                            child:
                                NoDataScreen(mTitle: languages.lblResultNoFound)
                                    .visible(mSearchBlogList.isEmpty)
                                    .center()
