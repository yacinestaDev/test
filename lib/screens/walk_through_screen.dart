...
class _WalkThroughScreenState extends State<WalkThroughScreen> {
  ...
  init() async {
    //
    mWalkList
        .add(WalkThroughModel(image: ic_walk1, title: languages.WALK1_TITLE));
    mWalkList
        .add(WalkThroughModel(image: ic_walk2, title: languages.WALK2_TITLE));
    mWalkList
        .add(WalkThroughModel(image: ic_walk3, title: languages.WALK3_TITLE));
  }
