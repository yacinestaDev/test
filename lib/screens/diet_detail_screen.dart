...
class _DietDetailScreenState extends State<DietDetailScreen> {
  ...
  init() async {
    if (userStore.adsBannerDetailShowAdsOnDietDetail == 1)
      loadInterstitialAds();
  }
              ...
              child: Stack(
                ...
                children: [
                  Stack(
                    clipBehavior: Clip.none,
                    children: [
                      cachedImage(widget.dietModel!.dietImage.validate(),
                          width: context.width(),
                  ...
                  Positioned(
                      ...
                      child: Container(
                          ...
                          child: Image.asset(
                            ...
                            height: 20,
                            width: 20,
                            color: widget.dietModel!.isFavourite == 1
                          ...
                          child: RichText(
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(
                                    text:
                                        widget.dietModel!.totalTime.validate(),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          getVitamins(
                                  ic_calories,
                                  widget.dietModel!.calories.validate() +
                                      " " +
                                      languages.lblKcal,
                          ...
                          getVitamins(
                                  ic_carbs,
                                  widget.dietModel!.carbs.validate() +
                                      " ${languages.lblG}",
                                  languages.lblCarbs)
                              .expand(),
                          dividerHorizontalLine(),
                          ...
                          getVitamins(
                                  ic_protein,
                                  widget.dietModel!.protein.validate() +
                                      " ${languages.lblG}",
